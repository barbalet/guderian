...
struct GuderianBattleUISwiftTests {
    ...
    func guderianPlayableBattleExposesOrderDiceBagGameplay() throws {
        ...
        #expect(source.contains("prepareNextOrderDiceActivation(selectsUnit: false)"))
        ...
        #expect(catalystSource.contains("prepareNextOrderDiceActivation(selectsUnit: false)"))
